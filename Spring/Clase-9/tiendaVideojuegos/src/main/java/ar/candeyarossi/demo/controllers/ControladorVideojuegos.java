...
public class ControladorVideojuegos implements ManejoDeFechas {
	...
	public String comprar(@PathVariable("id") Long idJuego, HttpSession sesion, Model modelo) {
		...
		Usuario comprador = this.servicioUsuarios.obtenerUsuarioPorId(u.getId());
		Videojuego juego = this.servicioVideojuegos.obtenerVideojuegoPorId(idJuego);
		...
		this.servicioUsuarios.crearModificarUsuario(comprador);
